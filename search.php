    ...
    <div class="osahan-popular">
        ...
        <div class="container">
            <div class="search py-5">
                <div class="input-group bg-white rounded-pill border mb-4">
                    <input type="text" class="form-control form-control-lg bg-transparent border-0 rounded-0" id="inlineFormInputGroup" value="Osahan eats...">
                    <button class="btn bg-white text-primary bg-transparent border-0 rounded-0" type="button"><i class="feather-search"></i></button>
                  </div>
                <!-- nav tabs -->
                <ul class="nav nav-tabs border-0" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active border-0 bg-light text-dark rounded" id="home-tab" data-bs-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><i class="feather-home me-2"></i>Restaurants (8)</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link border-0 bg-light text-dark rounded ms-3" id="profile-tab" data-bs-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false"><i class="feather-disc me-2"></i>Dishes (23)</a>
                    </li>
                </ul>
                            ...
                            <div class="row g-4">
                                    ...
                                    <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                        ...
                                        <div class="p-3 position-relative">
                                            <div class="list-card-body">
                                                <h6 class="mb-1"><a href="restaurant.php" class="text-black">The osahan Restaurant
                                          </a>
                                                </h6>
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                        ...
                                        <div class="p-3 position-relative">
                                            <div class="list-card-body">
                                                <h6 class="mb-1"><a href="restaurant.php" class="text-black">Thai Famous Indian Cuisine</a></h6>
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                        ...
                                        <div class="p-3 position-relative">
                                            <div class="list-card-body">
                                                <h6 class="mb-1"><a href="restaurant.php" class="text-black">Bite Me Now Sandwiches</a></h6>
                ...
                <div class="row pt-3">
                    ...
                    <aside class="col-sm-3  col-md-2 text-white">
                        ...
                        <ul class="list-unstyled hov_footer">
                            ...
                            <li> <a href="profile.php" class="text-muted"> Account Setting </a></li>
                        </ul>
                    </aside>
                    <aside class="col-sm-3  col-md-2 text-white">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-check border-bottom px-0  custom-radio">
                            ...
                            <label class="form-check-label py-2 w-100 px-3" for="customRadio1f">Top Rated</label>
                        </div>
                        <div class="form-check border-bottom px-0  custom-radio">
                            <input type="radio" id="customRadio2f" name="location" class="form-check-input">
                            <label class="form-check-label py-2 w-100 px-3" for="customRadio2f">Nearest Me</label>
                        </div>
                        <div class="form-check border-bottom px-0  custom-radio">
                            <input type="radio" id="customRadio3f" name="location" class="form-check-input">
                            <label class="form-check-label py-2 w-100 px-3" for="customRadio3f">Cost High to Low</label>
                        </div>
                        <div class="form-check border-bottom px-0  custom-radio">
                            <input type="radio" id="customRadio4f" name="location" class="form-check-input">
                            <label class="form-check-label py-2 w-100 px-3" for="customRadio4f">Cost Low to High</label>
                        </div>
                        <div class="form-check border-bottom px-0  custom-radio">
                            <input type="radio" id="customRadio5f" name="location" class="form-check-input">
                            <label class="form-check-label py-2 w-100 px-3" for="customRadio5f">Most Popular</label>
                        </div>
                        <!-- Filter -->
                        <h6 class="mt-4">FILTER</h6>
                        <div class="form-check border-bottom px-0  custom-checkbox">
                            <input type="checkbox" class="form-check-input" id="defaultCheck1" checked>
                            <label class="form-check-label py-2 w-100 px-3" for="defaultCheck1">Open Now</label>
                        </div>
                        <div class="form-check border-bottom px-0  custom-checkbox">
                            <input type="checkbox" class="form-check-input" id="defaultCheck2">
                            <label class="form-check-label py-2 w-100 px-3" for="defaultCheck2">Credit Cards</label>
                        </div>
                        <div class="form-check border-bottom px-0  custom-checkbox">
                            <input type="checkbox" class="form-check-input" id="defaultCheck3">
                            <label class="form-check-label py-2 w-100 px-3" for="defaultCheck3">Alcohol Served</label>
                        </div>
                        <!-- Filter -->
